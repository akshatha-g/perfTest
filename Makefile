...
all: mp_small mp_big throughput_rd file_rd ioctl rd_all read_client throughput_small utils.o
...
clean:
	rm -f mp_small mp_big throughput_rd file_rd ioctl rd_all read_client throughput_small *.o
